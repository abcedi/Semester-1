...
// Todo:
void removeAppointment(struct Appointment* app, int max, struct Patient* patient, int maxPatient);
...
// input/setting year, month and day to structure
void getDate(int* year, int* month, int* day);

// input/setting hour and minutes to structure
